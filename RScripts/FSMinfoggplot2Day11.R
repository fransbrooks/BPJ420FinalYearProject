...
setwd("/home/frans/Documents/BPJ420/CarrierPlanInterpreter/Day11")
...
FSMinfoRunFixAndVar <- read.csv("Day11_80_vehicleTypesFixedRunningAndVariablesumValues.csv")
...
FSMinfoVar <- read.csv("Day11_80_vehicleTypesOnlyVariablesumValues.csv")
...
FSMinfoRunFix <- read.csv("Day11_80_vehicleTypesOnlyFixedRunningsumValues.csv")
...
FSMinfoFixAndVar <- read.csv("Day11_80_vehicleTypesAbsFixAndVarsumValues.csv")
...
FSMinfoFix <- read.csv("Day11_80_vehicleTypesOnlyAbsFixsumValues.csv")
...
setwd("/home/frans/Documents/BPJ420/Rplots/Day11")
...
g <- g + theme_bw(base_size = 18) + ggtitle("Total cost, day 11") 
...
StackPlot <- StackPlot + theme_bw(base_size = 18) + ggtitle("Fleet composition, day 11")
StackPlot
pdf("Day11FC.pdf", width = 10)
print(StackPlot)
dev.off()
...
FSMinfo$VehicleID <- factor(x = FSMinfo$VehicleID, c("truck_3_1","truck_3_1_0", "truck_3_1_1", "truck_6_1", "truck_6_1_0",  "truck_12_1", "truck_12_1_0", "truck_12_1_1","truck_15_1", "truck_15_1_0", "truck_15_1_1"))
...
DistanceStackPlot <- DistanceStackPlot + theme_bw(base_size = 18) + ggtitle("Distance travelled, day 11") + geom_text(aes(label =TotalDistKM), position = "stack", hjust = 0.5, vjust = 1.1)
...
DistanceStackPlot
pdf("DistanceDay11.pdf", width = 11)
