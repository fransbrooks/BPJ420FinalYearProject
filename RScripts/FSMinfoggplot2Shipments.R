...
setwd("/home/frans/Documents/BPJ420/CarrierPlanInterpreter/shipments")
...
setwd("/home/frans/Documents/BPJ420/Rplots/shipments")
...
DistanceStackPlot <- DistanceStackPlot + theme_bw(base_size = 18) + ggtitle("Distance travelled, day 12") + geom_text(aes(label =TotalDistKM), position = "stack", hjust = 0.5, vjust = 1.1)
...
DistanceStackPlot
pdf("DistanceDay12.pdf", width = 11)
