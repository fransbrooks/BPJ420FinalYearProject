...
g <- g + theme_bw(base_size = 18) + ggtitle("Total cost, day 5") 
...
StackPlot <- StackPlot + theme_bw(base_size = 18) + ggtitle("Fleet composition, day 5")
StackPlot
pdf("Day5FC.pdf", width = 10)
print(StackPlot)
dev.off()
...
FSMinfo$VehicleID <- factor(x = FSMinfo$VehicleID, c("truck_3_1","truck_3_1_0", "truck_3_1_1", "truck_6_1", "truck_6_1_0",  "truck_12_1", "truck_12_1_0", "truck_15_1", "truck_15_1_0", "truck_15_1_1"))
